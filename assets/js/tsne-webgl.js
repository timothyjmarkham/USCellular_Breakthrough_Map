...
function loadData() {
  get('brand_counts.json', function(data) {
    ...
    {x: "Verizon", value: brandCountsHolder["Verizon"]},
    {x: "TMobile", value: brandCountsHolder["TMobile"]},
    {x: "MetroPCS", value: brandCountsHolder["MetroPCS"]}
];
  })    
...
function addWindowEventListeners() {
  ...
  window.addEventListener('hashchange', function(e) {
    ...
    marker.XPos = (((coords.x + 13400)/(8180 + 13400)) * 300) - (marker.Width / 2);
    marker.YPos = (193 - ((coords.y + 6592)/(8448 + 6592)) * 193) - marker.Height;
    ...
    {x: "Verizon", value: thisClusterData["Verizon"]},
    {x: "TMobile", value: thisClusterData["TMobile"]},
    {x: "MetroPCS", value: thisClusterData["MetroPCS"]}
    ]
...
mapSprite.src = "assets/images/USCC Full Map.png";
